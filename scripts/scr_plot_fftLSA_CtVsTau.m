function scr_plot_fftLSA_CtVsTau(HeaderLines, FileColumnsToPlot, XPlotLabel, YPlotLabel, PlotLegendLabels, PlotColors, PlotMarkers)
% Plotting auto-covarinace Ct (experimental and fitted) vs Tau (lag time)
...
for k = 1:size(fileList, 1)
    ...
    for i = HeaderOffset:txtbLength        
        ...
        data(k).Y4(i - HeaderLines) = xyBuffer(4);
    end
...
% Save graph
plots_SavePlotAsImage2('Graph_', hFig, 'png', '-opengl', ['Ct' 'Vs' 'Tau']);
